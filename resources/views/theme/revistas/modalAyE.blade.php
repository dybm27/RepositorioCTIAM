<div class="modal fade in" id="modalRevistas" role="dialog">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="box box-primary">
                            <div class="modal-header with-border">
                                ...
                                <h3 id="modalT" class="modal-title">Agregar Revista</h3>
                            </div>
                            <!-- /.box-header -->   
                            <!-- form start -->
                            <div class="modal-body">
                                <span id="form_results"></span>
                                <form  id="formRevistas" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group archivo">
                                        <label id="nomRev" for="examplse">Nueva Revista</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" id="revista_id" name="revista_id" value="0">
                            </div>
                        </div>
                    </div>
                </div>
